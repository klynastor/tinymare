/* Licensing Information for TinyMARE:
 * Copyright 1993-2017 by Byron Stanoszek
 * All Rights Reserved
 * _________________________________________________________________________
 * 
 * This archive of TinyMARE has been developed over seven years by the named
 * authors above.  An active effort exists to support  upgrades on a regular
 * basis in which numerous bugs and glitches shall continue to be fixed. The
 * various utility programs contained within the package are also under this
 * copyright notice. Credit for borrowed ideas and code used in the creation
 * of the TinyMARE server is given to many MUDs and other programmers listed
 ...
 * 
 * Changing the copyright information stored below is an infringement upon
 * the agreement listed above.
 */
